  ...
  implements OnDestroy
{
  ...
  agInit(params: any): void {
    ...
    this.content += `
    <div class='action-tool' data-action="onboarding-detail" style="margin-bottom: 5px;">
      <i style="margin-right: 10px; font-size: 17px; cursor: pointer;" class="fa fa-eye" title="Edit Role" data-action="edit-role"></i> 
     View Details
    </div>`;
