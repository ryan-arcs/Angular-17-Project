...
const lookupModules = ['users', 'life-cycles', 'vendors', 'departments'];
@Component({
  selector: 'app-xapps-admin-left-sidebar',
  standalone: true,
...
export class LeftSidebarComponent {
  ...
  ngOnDestroy(): void {
    // Unsubscribe from the routeChangeEventSubscription to prevent memory leaks
