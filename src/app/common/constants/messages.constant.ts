...
export const messages = {
  error: {
    ...
    appAccessRequest: {
      ...
      notFound: 'Application access request not found!',
    },
  },
  success: {
    appAccessRequest: {
      add: 'Your request has been submitted successfully!',
      delete: 'Application Access request deleted successfully!',
      success: 'Your comment is added successfully!',
      noRowFound: 'No requests available!',
    },
    feedback: {
      add: 'Thank you for the feedback. Your submission has been received successfully!',
      delete: 'Feedback deleted successfully!',
      success: 'Your comment is added successfully!',
      noRowFound: 'No feedback available!',
    },
  },
};

export const motivationalQuotesList = [
  {
